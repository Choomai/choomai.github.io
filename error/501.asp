    ...
    <body id="body">
        <div class="container">
            ...
            <div id="err_info" class="err-info">
                <div id="wait_notify" class="center">Loading error info...<br>If the error doesn't load after 10s, it means that the <b>server is down</b> and I am currently fixing it. </div>
                <div id="info_0"></div>
                <div id="info_1"></div>
            </div>
            ...
            <div id="contact" class="center">
                ...
                <a href="https://twitter.com/choomai0"><img class="profile" src="https://cdn-icons-png.flaticon.com/128/733/733579.png" alt="Images not available"></a>
